...
$configuration = [
    'action' => 'bootstrap',
    'instanceID' => 4243,
    'configurationRevision' => 'browser-fixture-v6',
    'items' => $items,
    'settings' => [
        'autoLoop' => false,
        'loopSeconds' => 8,
