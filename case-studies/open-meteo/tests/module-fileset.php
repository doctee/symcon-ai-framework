...
try {
    ...
    openMeteoFilesetSame(42, count($sourceMap['files'] ?? []), 'Fileset source count differs.');
    ...
    foreach (
        [
        'library.json',
        'DwdPrecipitationNowcast/module.php',
        ...
        'libs/OpenMeteo/LocalHorizonModel.php',
        'libs/OpenMeteo/LocalHorizonProfile.php',
