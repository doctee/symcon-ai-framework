...
try {
    ...
    openMeteoPublicationTestSame(43, $checkResult['fileCount'] ?? null, 'Publication file count differs.');
    ...
    openMeteoPublicationTestSame(43, count($preparedFiles), 'Prepared file inventory differs.');
    ...
    openMeteoPublicationTestSame(39, count($sourceMap['files'] ?? []), 'Prepared payload count differs.');
