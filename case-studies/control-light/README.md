...
- `142-uniform-color-command-contract.md` records explicit color power-on with
  retained brightness, member-confirmed RGB groups and the separate technical,
  optical and spoken-assistant acceptance gates.
