...
$requiredScriptFragments = [
    ...
    "'IPS_RunScriptWaitEx'",
    'Invoke-RuntimeHealthProbe',
    '$decodedFunctions -isnot [System.Array]',
    '$requiredFunctions = [object[]] $decodedFunctions',
    "runtimeHealthCheck = 'source_hash'",
    "runtimeHealthCheck = 'result_contract'",
    'runtimeHealthCheck = $script:runtimeHealthCheck',
    'Runtime health probe rejected the active function contract.',
    ...
    'Credential sources are mutually exclusive.',
