...
$requiredGatewayFragments = [
    ...
    'Invoke-ScopeBoundApprovalRunner',
    'New-ScopeBoundApprovalPlan',
    "[string] \$runnerStatus.outcome -ceq 'aborted' -and",
    "outcome = 'approval_resume_required'",
    "\$details['approvalPlan'] = \$status.approvalPlan",
    "[string] \$parts[2] -cne 'approved'",
    "'package-transfer.json'",
    'approvalRunnerPath',
    'expectedApprovalRunnerSha256',
    'approvalPolicyPath',
    'expectedApprovalPolicySha256',
...
foreach (
    [
        ...
        'Invoke-StandaloneTargetAddition',
        'Assert-InitialSetupTargetSafety',
        'expectedApprovalRunnerSha256',
        'expectedApprovalPolicySha256',
        'ExpectedAdditionPlanSha256',
        'Incomplete target addition requires recovery review.',
